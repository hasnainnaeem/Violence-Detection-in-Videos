...
#									return_elements=["2-maxpool", "32-leaky"])
		...
		with tf.name_scope("CNN"):
			...
			'''
			print("In CNN:")
			print("\t darknetOutput.shape = ", out.shape)   # shape = [b*u*1, 7, 7, 1024]
	...
	def _buildOpticalFlowNet(self, inputTensor_):
		with tf.name_scope("OpticalFLow"):
			...
			print("\t before Conv2, out.shape = ", inputTensor_.shape)  # shape = [b*u*1, 112, 112, 32]
			out = ConvLayer('Conv2', inputTensor_, filterSize_=3, numberOfFilters_=64,
