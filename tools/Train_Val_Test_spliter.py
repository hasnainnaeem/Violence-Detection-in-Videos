...
try:
    LIST_OF_NO_FIGHT_DIR = [sys.argv[2] + "\\NonViolence\\"]
    LIST_OF_FIGHT_DIR = [sys.argv[2] + "\\Violence\\"]
except:
    LIST_OF_NO_FIGHT_DIR = [".\\dataset\\NonViolence\\"]
    LIST_OF_FIGHT_DIR = [".\\dataset\\Violence\\"]

VAL_SET_RATIO = 0.1
TEST_SET_RATIO = 0.4  # NUMBER_OF_TEST_SET = NUMBER_OF_TOTAL_DATA * TEST_SET_RATIO


PATH_TO_SAVE_SPLITED_DATASET = ".\\datalists\\"
